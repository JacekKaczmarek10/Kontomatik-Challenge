...
public class Login3RequestProcessor {
    ...
    public String processRequest(OTPSubmitRequest loginRequest) throws JsonProcessingException {
    ...
    public LoginResponse executeRequest(OTPSubmitRequest loginRequest) throws IOException {
        setHeaders();
