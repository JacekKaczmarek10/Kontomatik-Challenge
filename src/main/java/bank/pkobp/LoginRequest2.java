...
public class LoginRequest2 {
    ...
    static class Data {
        ...
        public Integer getPlacementPageNo() {
            return placementPageNo;
        }

        public void setPlacementPageNo(Integer placementPageNo) {
            this.placementPageNo = placementPageNo;
        }
        ...
        public String getBehavioralTrackingId() {
            return behavioralTrackingId;
        }

        public void setBehavioralTrackingId(String behavioralTrackingId) {
            this.behavioralTrackingId = behavioralTrackingId;
        }
    }
}